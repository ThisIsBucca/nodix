...
import shanas from  './../../public/shanas.jpg'
...
export default function Table() {
  ...
  return (
    <div   className=" overflow-x-auto lg:mt-24 origin-top flex flex-col items-center justify-center py-20" data-theme={'wireframe'}>
      <h2 className='text-3xl  font-bold'>Nodix <span className='text-nodix-primary'>Buddies</span></h2>
      <table className="table table-compact w-3/5 mt-10">
        <thead className='border-dashed border-2 border-nodix-primary'>
          <tr >
            <th >Name</th>
            <th >Skills</th>
            <th >Phone</th>
        ...
        <tbody  >
          ...
          <tr>
            <td>
              ...
              <div>
                <div className='font-bold '>Abubakar</div>
                <div className='text-sm opacity-50'>Tanzania</div>
              </div>
            </td>
            <td> <span >Backend developer</span>
          ...
          <tr>
            <td>
              ...
              <div>
                <div className='font-bold '>Shanas</div>
                <div className='text-sm opacity-50'>Tanzania</div>
              </div>
            </td>
          ...
          <tr>
            <td>
              ...
              <div>
                <div className='font-bold '>Komba</div>
                <div className='text-sm opacity-50'>Tanzania</div>
              </div>
            </td>
            <td> <span >Information security</span>
          ...
          <tr>
            <td>
              ...
              <div>
                <div className='font-bold '>Amani</div>
                <div className='text-sm opacity-50'>Tanzania</div>
              </div>
            </td>
            <td> <span >Fullstack developer</span>
