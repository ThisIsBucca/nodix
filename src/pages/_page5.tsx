  ...
  return ( 
    ...
    <Image
      ...
      />
        ...
        <ul className='menu menu-horizontal  rounded-box border-b-4 border-error'>

               <li>
               <a href='https://twitter.com/Nodix_Inc?t=QCeE-a9-1UJYnb9EpthkjA&s=09' target='_blank' rel='noopener'>
                   <AiOutlineTwitter className='text-3xl  hover:text-error hover:border-2 hover:border-error  hover:rounded-full hover:p-1 ' />
                   </a>
               </li>

               <li>
               <a href='https://instagram.com/nodix_inc?igshid=NTc4MTIwNjQ2YQ==' target='_blank' rel='noopener'>
                   <FaInstagram className='text-3xl hover:text-error hover:border-2 hover:border-error  hover:rounded-full hover:p-1 ' />
                   </a>
               </li>

               <li>
               <a href='https://www.facebook.com/profile.php?id=100092351478138&mibextid=2JQ9oc' target='_blank' rel='noopener'>
                   <FaFacebook className='text-3xl hover:text-error hover:border-2 hover:border-error  hover:rounded-full hover:p-1 ' />
                   </a>
               </li>
            </ul>
