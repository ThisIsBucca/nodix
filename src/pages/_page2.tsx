...
export default function Page2() {
  ...
  return (
    ...
    <div className='w-full lg:mb-24 h-auto flex items-center justify-center' data-theme={'wireframe'}>
      <div className='w-full h-auto  pb-10 pt-10   flex gap-2  flex-col  justify-center items-center  lg:gap-10  lg:h-screen  radial' id='feature '>


        <h2 className='text-xl w-3/5 lg:w-full text-center  lg:text-3xl font-bold'> <span className='border-b-4 border-nodix-primary'>And this is what</span> makes nodix special</h2>
